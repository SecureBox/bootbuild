...
var editableContent = ['.editContent, .navbar a, button, a.btn'];
...
$(function(){
	...
	$('button#updateContentInFrameSubmit').click(function(){
		...
		elToUpdate.html( $('#editContentModal #contentToEdit').redactor('code.get') )
	...
	$('#updateContentInFrameCancel').click(function(){
